...
[![Build Status](https://github.com/khulnasoft/kube-hunter/workflows/Test/badge.svg)](https://github.com/khulnasoft/kube-hunter/actions)
[![codecov](https://codecov.io/gh/khulnasoft/kube-hunter/branch/main/graph/badge.svg)](https://codecov.io/gh/khulnasoft/kube-hunter)
[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)
[![License](https://img.shields.io/github/license/khulnasoft/kube-hunter)](https://github.com/khulnasoft/kube-hunter/blob/main/LICENSE)
[![Docker image](https://images.microbadger.com/badges/image/khulnasoft/kube-hunter.svg)](https://microbadger.com/images/khulnasoft/kube-hunter "Get your own image badge on microbadger.com")

[download]: https://img.shields.io/github/downloads/khulnasoft/kube-hunter/total?logo=github
[release-img]: https://img.shields.io/github/release/khulnasoft/kube-hunter.svg?logo=github
[release]: https://github.com/khulnasoft/kube-hunter/releases
[docker-pull]: https://img.shields.io/docker/pulls/khulnasoft/kube-hunter?logo=docker&label=docker%20pulls%20%2F%20kube-hunter

kube-hunter hunts for security weaknesses in Kubernetes clusters. The tool was developed to increase awareness and visibility for security issues in Kubernetes environments. **You should NOT run kube-hunter on a Kubernetes cluster that you don't own!**

**Run kube-hunter**: kube-hunter is available as a container (khulnasoft/kube-hunter), and we also offer a web site at [kube-hunter.khulnasoft.com](https://kube-hunter.khulnasoft.com) where you can register online to receive a token allowing you to see and share the results online. You can also run the Python code yourself as described below.

**Explore vulnerabilities**: The kube-hunter knowledge base includes articles about discoverable vulnerabilities and issues. When kube-hunter reports an issue, it will show its VID (Vulnerability ID) so you can look it up in the KB at https://khulnasoft.github.io/kube-hunter/  
...
~~~
git clone https://github.com/khulnasoft/kube-hunter.git
~~~
...
### Container
Khulnasoft Security maintains a containerized version of kube-hunter at `khulnasoft/kube-hunter:khulnasoft`. This container includes this source code, plus an additional (closed source) reporting plugin for uploading results into a report that can be viewed at [kube-hunter.khulnasoft.com](https://kube-hunter.khulnasoft.com). Please note, that running the `khulnasoft/kube-hunter` container and uploading reports data are subject to additional [terms and conditions](https://kube-hunter.khulnasoft.com/eula.html).
...
`docker run -it --rm --network host khulnasoft/kube-hunter`
...
`docker run --rm khulnasoft/kube-hunter --cidr 192.168.0.0/24`
...
## Contribution 
To read the contribution guidelines, <a href="https://github.com/khulnasoft/kube-hunter/blob/main/CONTRIBUTING.md"> Click here </a>

## License
This repository is available under the [Apache License 2.0](https://github.com/khulnasoft/kube-hunter/blob/main/LICENSE).
